...
public class OffersController : ControllerBase
{
        ...
        CancellationToken ct = default)
    {
        ...
        var result = offers
            ...
            .Select(o => new
            {
                o.Id, o.Title, o.Description, o.Price, o.OriginalPrice,
                o.Currency, o.Emoji, o.CategoryId, o.QuantityAvailable, o.IsFeatured,
                DiscountPercent = o.DiscountPercent,
                Vendor = vendors.TryGetValue(o.VendorId, out var v) ? new
                {
                    v.Id, v.Name, v.City, v.District,
                    v.LogoEmoji, v.Rating, v.RatingCount, v.OpenHours,
    ...
    public record CreateOfferRequest(
        Guid VendorId, Guid CategoryId, string Title, string Description,
        decimal Price, decimal? OriginalPrice, string? Emoji);
    ...
    public async Task<IActionResult> Create([FromBody] CreateOfferRequest req, CancellationToken ct)
    {
        ...
        var offer = new Offer
        {
            ...
            VendorId = req.VendorId, CategoryId = req.CategoryId,
            Title = req.Title, Description = req.Description ?? "",
            Price = req.Price, OriginalPrice = req.OriginalPrice,
            Emoji = req.Emoji ?? "🍽️", IsActive = true, IsFeatured = false,
        };
    ...
    public async Task<IActionResult> Get(Guid id, CancellationToken ct)
    {
        ...
        return this.OkEnvelope("offer.get", new
        {
            ...
            {
                v.Id, v.Name, v.Description, v.City, v.District, v.Phone,
                v.LogoEmoji, v.CoverEmoji, v.Rating, v.RatingCount, v.OpenHours,
                v.Latitude, v.Longitude
            }
        });
    }
