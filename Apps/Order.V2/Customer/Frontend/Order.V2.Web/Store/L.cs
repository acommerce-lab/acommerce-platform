...
public sealed class CustomerTranslations : EmbeddedTranslationProvider
{
    ...
    private static readonly Dictionary<string, string> _ar = new()
    {
        ...
        ["order.success_subtitle"] = "سيؤكد المتجر طلبك قريباً جداً",
        ["order.view_order"] = "تفاصيل الطلب",
        ["order.continue_shopping"] = "متابعة التسوق",
        ["order.not_found"] = "الطلب غير موجود",
        ["order.items"] = "العناصر",
        ["order.vendor"] = "المتجر",
        ["order.pickup"] = "الاستلام",
        ["order.payment"] = "الدفع (في المتجر)",
        ["order.cash_tendered"] = "المبلغ المتوقع",
        ["order.expected_change"] = "الباقي المتوقع",
        ["order.notes"] = "ملاحظاتك",
        ...
        ["vendor.offers"] = "عروض المتجر",
        ["vendor.not_found"] = "المتجر غير موجود",
        ["vendor.home"] = "الرئيسية",
        ["vendor.no_offers"] = "لا توجد عروض حالياً",

        ["search.title"] = "البحث",
        ["search.placeholder"] = "ابحث عن عرض…",
        ["search.discover"] = "اكتشف",
        ["search.placeholder_advanced"] = "متجر، منتج، حي...",
        ["search.map_view"] = "خريطة",
        ["search.list_view"] = "قائمة",
        ["search.no_results"] = "لا توجد نتائج",
        ["search.no_results_message"] = "جرّب فلتراً آخر أو ابحث باسم آخر",
        ["search.stores"] = "المتاجر",
        ["search.offers"] = "العروض",
        ["search.advanced_filters"] = "فلاتر متقدمة",
        ["search.discounted_only"] = "مع خصم فقط",
        ["search.min_price"] = "السعر من",
        ["search.max_price"] = "إلى",
        ["search.min_rating"] = "الحد الأدنى للتقييم",
        ["search.discount"] = "خصم",
        ["search.clear_all"] = "مسح الكل",
        ["search.view_store_menu"] = "عرض قائمة المتجر",
        ["search.view_details"] = "عرض التفاصيل",
        ...
        ["profile.not_signed_in"] = "أنت غير مسجل",
        ["profile.points"] = "نقاط",

        ["account.title"] = "تعديل الحساب",
        ["account.subtitle"] = "حدّث بياناتك الشخصية",
        ["account.personal_info"] = "البيانات الشخصية",
        ["account.full_name"] = "الاسم الكامل",
        ["account.full_name_placeholder"] = "أدخل اسمك الكامل",
        ["account.email"] = "البريد الإلكتروني",
        ["account.email_placeholder"] = "أدخل بريدك الإلكتروني",
        ["account.car_details"] = "بيانات السيارة",
        ["account.car_details_hint"] = "تُستخدم عند الاستلام من السيارة (Curbside)",
        ["account.car_model_placeholder"] = "مثال: كامري 2024",
        ["account.car_color_placeholder"] = "مثال: أبيض",
        ["account.car_plate_placeholder"] = "اختياري",
        ["account.saving"] = "جاري الحفظ...",
        ["account.save_changes"] = "حفظ التعديلات",
        ["account.name_required"] = "الاسم مطلوب",
        ["account.saved_successfully"] = "تم حفظ التعديلات بنجاح",
        ["account.save_failed"] = "تعذّر حفظ التعديلات",
    ...
    private static readonly Dictionary<string, string> _en = new()
    {
        ...
        ["order.success_subtitle"] = "The store will confirm shortly",
        ...
        ["order.vendor"] = "Store",
        ["order.pickup"] = "Pickup",
        ["order.payment"] = "Payment (at pickup)",
        ["order.cash_tendered"] = "Cash tendered",
        ["order.expected_change"] = "Expected change",
        ["order.notes"] = "Notes",
        ...
        ["vendor.offers"] = "Store offers",
        ["vendor.not_found"] = "Store not found",
        ["vendor.home"] = "Home",
        ["vendor.no_offers"] = "No offers right now",

        ["search.title"] = "Search",
        ["search.placeholder"] = "Search for an offer…",
        ["search.discover"] = "Discover",
        ["search.placeholder_advanced"] = "Store, product, district...",
        ["search.map_view"] = "Map",
        ["search.list_view"] = "List",
        ["search.no_results"] = "No results",
        ["search.no_results_message"] = "Try a different filter or search",
        ["search.stores"] = "Stores",
        ["search.offers"] = "Offers",
        ["search.advanced_filters"] = "Advanced filters",
        ["search.discounted_only"] = "Discounted only",
        ...
        ["search.view_store_menu"] = "View store menu",
        ...
        ["account.title"] = "Edit Account",
        ["account.subtitle"] = "Update your personal info",
        ["account.personal_info"] = "Personal Info",
        ["account.full_name"] = "Full Name",
        ["account.full_name_placeholder"] = "Enter your full name",
        ["account.email"] = "Email",
        ["account.email_placeholder"] = "Enter your email",
        ["account.car_details"] = "Car Details",
        ["account.car_details_hint"] = "Used for curbside pickup orders",
        ["account.car_model_placeholder"] = "e.g. Camry 2024",
        ["account.car_color_placeholder"] = "e.g. White",
        ["account.car_plate_placeholder"] = "Optional",
        ["account.saving"] = "Saving...",
        ["account.save_changes"] = "Save Changes",
        ["account.name_required"] = "Name is required",
        ["account.saved_successfully"] = "Changes saved successfully",
        ["account.save_failed"] = "Could not save changes",
