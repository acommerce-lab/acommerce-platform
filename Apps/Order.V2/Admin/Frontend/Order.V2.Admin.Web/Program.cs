...
using Order.V2.Admin.Web.Components;
using Order.V2.Admin.Web.Interceptors;
using Order.V2.Admin.Web.Interpreters;
using Order.V2.Admin.Web.Operations;
using Order.V2.Admin.Web.Services;
...
var apiBase = builder.Configuration["OrderV2AdminApi:BaseUrl"] ?? "http://localhost:5103";
builder.Services.AddHttpClient("order-v2-admin", c =>
{
