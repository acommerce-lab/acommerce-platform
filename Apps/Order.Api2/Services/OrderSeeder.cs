...
namespace Order.Api2.Services;

/// <summary>
/// يبذر اوردر بمتاجر تجريبية + عروض + عميل ديمو + إشعارات.
/// يُستدعى مرة عند بدء التشغيل (idempotent — يخرج إذا كان فيه بيانات).
/// </summary>
