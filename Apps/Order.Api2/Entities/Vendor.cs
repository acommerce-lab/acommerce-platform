...
/// <summary>
/// تاجر اوردر — كافيه أو مطعم أو حلويات. كل عرض يخص تاجراً واحداً.
/// </summary>
public class Vendor : IBaseEntity
{
    ...
    public Guid OwnerId { get; set; }              // -> User.Id (vendor role)
    ...
    // Working hours stored as a CSV "open|close" e.g. "07:00|23:00"
