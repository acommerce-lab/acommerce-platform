...
/// تستخدم <c>AshareV3DbContext</c> حيثما توفّرت البيانات في القاعدة، و<c>AshareV3Seed</c>
...
public sealed class CatalogController : ControllerBase
{
    ...
    // AshareV3SubscriptionStore + AshareV3PlanStore + AshareV3InvoiceStore تترجم
    ...
    //    DELETE /my-listings/{id}).  AshareV3ListingStore يترجم بين IListing و
    ...
    // AshareV3FavoritesStore يُترجم بين IFavoritesStore و Favorite entity.
    ...
    // الـ controller الجديد يستهلك ISupportStore (AshareV3SupportStore) +
    ...
    private async Task SubscribeBothPartiesAsync(Guid convId, Guid a, Guid b, CancellationToken ct)
    {
        ...
        // raw guid (مطابق لـ AshareV3RealtimeHub.OnConnectedAsync و
    ...
    // للـ inbox والتفاصيل. الآن AshareV3CustomerChatStore يقرأ من EF فيُغذّيهما
