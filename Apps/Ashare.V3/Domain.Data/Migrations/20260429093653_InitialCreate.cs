        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SunsetAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeUnit = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    AmenitiesCsv = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ImagesCsv = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false),
                    CycleLabel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MaxActiveListings = table.Column<int>(type: "int", nullable: false),
                    MaxFeaturedListings = table.Column<int>(type: "int", nullable: false),
                    MaxImagesPerListing = table.Column<int>(type: "int", nullable: false),
                    IsRecommended = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FeaturesCsv = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListingsLimit = table.Column<int>(type: "int", nullable: false),
                    FeaturedLimit = table.Column<int>(type: "int", nullable: false),
                    ImagesPerListing = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
