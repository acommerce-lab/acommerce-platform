...
///
/// <para>السابق كان يستخدم AshareV3Seed.GetOrCreateUserId الذي يُرجع <c>"U-1"</c>
...
/// </summary>
public sealed class AshareV3CustomerAuthUserStore : IAuthUserStore
{
    private readonly AshareV3DbContext _db;
    public AshareV3CustomerAuthUserStore(AshareV3DbContext db) => _db = db;
...
/// <summary>
/// جسر بين Chat Kit و EF. كانت النسخة السابقة تقرأ من <c>AshareV3Seed.Conversations</c>
...
///
/// <para>هذا التطبيق يقرأ من <see cref="AshareV3DbContext"/> مباشرةً ويُسلّم
...
/// </summary>
public sealed class AshareV3CustomerChatStore : IChatStore
{
    ...
    private readonly AshareV3DbContext _db;
    public AshareV3CustomerChatStore(AshareV3DbContext db) => _db = db;
...
/// كان السابق يقرأ من <c>AshareV3Seed.Notifications</c> (قائمة بذور in-memory
...
///   <item>إنشاء الإشعار يحدث في <c>AshareV3CustomerChatStore.AppendMessageAsync</c>
///         عند كل رسالة جديدة (مرفقة بـ realtime broadcast على نفس الـ
///         conversation channel).</item>
/// </list>
/// </summary>
public sealed class AshareV3CustomerNotificationStore : INotificationStore
{
    private readonly AshareV3DbContext _db;
    public AshareV3CustomerNotificationStore(AshareV3DbContext db) => _db = db;
