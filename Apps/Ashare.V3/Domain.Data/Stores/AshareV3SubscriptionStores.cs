...
public sealed class AshareV3SubscriptionStore : ISubscriptionStore
{
    ...
    public AshareV3SubscriptionStore(AshareV3DbContext db) => _db = db;
...
{
    private readonly AshareV3DbContext _db;
    public AshareV3PlanStore(AshareV3DbContext db) => _db = db;
...
{
    private readonly AshareV3DbContext _db;
    public AshareV3InvoiceStore(AshareV3DbContext db) => _db = db;
