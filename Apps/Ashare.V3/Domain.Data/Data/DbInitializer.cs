...
{
    public static void Seed(AshareV3DbContext db)
    {
        ...
        // 2. Seed Categories
        foreach (var c in AshareV3Seed.Categories)
        {
        ...
        // 4. Seed Amenities
        foreach (var a in AshareV3Seed.Amenities)
        {
        ...
        // 6. Seed Listings
        foreach (var l in AshareV3Seed.Listings)
        {
    ...
    /// لديهم بيانات سابقة.
    /// </summary>
    public static void NormalizeFavoriteEntityType(AshareV3DbContext db)
    {
        try
        {
        ...
        catch
        {
            ...
            // الإقلاع. القراءة الدِفاعيّة في AshareV3FavoritesStore تُعَوِّض.
        }
    }
    ...
    /// </summary>
    public static void SeedDiscoveryIfMissing(AshareV3DbContext db)
    {
        var addedAny = false;
    ...
    /// </summary>
    public static void SeedAppVersionsIfMissing(AshareV3DbContext db)
    {
    ...
    /// الإنتاج الآن.</para>
    /// </summary>
    public static void EnsureAppVersionsTable(AshareV3DbContext db)
    {
