...
/// <summary>
/// إعدادات JWT لـ Vendor.Api.
/// </summary>
public class JwtOptions
{
    public string Issuer { get; set; } = "https://vendor.app";
    public string Audience { get; set; } = "vendor-api";
...
/// <summary>
/// مُصدر/مُتحقق JWT لـ Vendor.Api — يطبق ITokenIssuer + ITokenValidator.
/// </summary>
