...
/// </summary>
public sealed class EjarAdminCircuitHttp : IDisposable
{
    public HttpClient Client { get; }
    private readonly AppStore _store;

    public EjarAdminCircuitHttp(IHttpClientFactory factory, AppStore store)
    {
        Client = factory.CreateClient("ejar-admin");
        _store = store;
