...
namespace Ejar.Provider.Web.Interceptors;
...
/// </summary>
public sealed class EjarProviderCircuitHttp : IDisposable
{
    public HttpClient Client { get; }
    private readonly AppStore _store;

    public EjarProviderCircuitHttp(IHttpClientFactory factory, AppStore store)
    {
        Client = factory.CreateClient("ejar-provider");
        _store = store;
