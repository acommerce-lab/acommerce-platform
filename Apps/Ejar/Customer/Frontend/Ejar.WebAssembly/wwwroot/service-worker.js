...
const VERSION = 'ejar-pwa-v44-2026-05-17';
const SHELL_CACHE = `shell-${VERSION}`;

// عند التثبيت: لا نَستَدعي skipWaiting تِلقائياً. النَسخَة الجَديدَة تَنتَظِر
// في state "waiting" حتى يَضغَط المُستَخدِم زَرّ "تَحديث الآن" في الشَريط
// العَلوي (يَرسُمه AcPwaUpdateBanner عَبر JSInterop). هذا يَمنَع فُقدان
// عَمَل المُستَخدِم في تَبويب مَفتوح + يُبقي السُلوك واضِحاً لَه.
self.addEventListener('install', e => {
  // لا skipWaiting — الـ banner يُحَكِّم.
});
