...
internal static class AshareListingsSeed
{
    public static IEnumerable<Listing> All(DateTime now, Guid ownerId)
    {
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 50, floor: "second",
            furnished: "semi_furnished", amenities: new() { "ac", "kitchen" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 2, bathrooms: 2, area: 80, floor: "first",
            furnished: "semi_furnished", amenities: new() { "ac", "kitchen", "parking" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 3, bathrooms: 2, area: 120, floor: "third",
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 25,
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 4, bathrooms: 3, area: 160, floor: "fifth",
            furnished: "semi_furnished", amenities: new() { "ac", "elevator", "parking" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 22,
            furnished: "furnished", amenities: new() { "wifi", "ac" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 18,
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 3, bathrooms: 2, area: 130, floor: "fourth",
            furnished: "semi_furnished", amenities: new() { "ac", "elevator", "parking", "security" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 30,
            furnished: "furnished", gender: "female",
            amenities: new() { "wifi", "ac", "kitchen", "washer" });

        yield return Residential(now, ownerId,
            "للمشاركة بالأسبوع — حي حطين",
            "غرفة وصالة بالأسبوع لزائري الرياض.",
            price: 850, time: "week", district: "حطين", lat: 24.780, lng: 46.600,
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 40,
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 2, bathrooms: 2, area: 75, floor: "second",
            furnished: "semi_furnished", amenities: new() { "ac", "kitchen", "parking" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "villa", unitType: "room", rooms: 1, bathrooms: 1, area: 20,
            furnished: "furnished", gender: "male",
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 3, bathrooms: 2, area: 110, floor: "third",
            furnished: "semi_furnished", amenities: new() { "ac", "elevator", "parking" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 28,
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 2, bathrooms: 1, area: 65,
            furnished: "furnished", amenities: new() { "wifi", "ac", "kitchen", "parking" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "room", rooms: 1, bathrooms: 1, area: 24,
            furnished: "furnished", amenities: new() { "wifi", "ac" });
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "apartment", rooms: 3, bathrooms: 2, area: 140, floor: "fourth",
        ...
        yield return Residential(now, ownerId,
            ...
            propertyType: "building", unitType: "studio", rooms: 1, bathrooms: 1, area: 45, floor: "fifth",
        ...
        yield return Commercial(now, ownerId,
            ...
            propertyType: "shop", area: 80, floor: "ground", parking: "limited",
            workingHours: "24h", facilities: new() { "ac", "security" });
        ...
        yield return Commercial(now, ownerId,
            ...
            propertyType: "restaurant", area: 200, capacity: 60, parking: "available",
            workingHours: "business", facilities: new() { "ac", "kitchen", "fire_safety" });
        ...
        yield return Administrative(now, ownerId,
            ...
            propertyType: "office", area: 50, floor: "fifth", capacity: 6, parking: "available",
            workingHours: "business", facilities: new() { "wifi", "ac", "elevator", "security" });

        yield return Administrative(now, ownerId,
            "قاعة اجتماعات VIP",
            "قاعة اجتماعات بسعة 12 شخص، مع جهاز عرض ومرطبات.",
            price: 500, time: "day", district: "العليا", lat: 24.708, lng: 46.680,
            propertyType: "meeting_room", area: 35, capacity: 12, parking: "available",
            workingHours: "business", facilities: new() { "wifi", "ac", "projector", "video_conf" });
        ...
        yield return Administrative(now, ownerId,
            ...
            propertyType: "full_floor", area: 800, floor: "fifth", capacity: 50, parking: "available",
            workingHours: "business", facilities: new() { "wifi", "ac", "elevator", "security", "reception" });
    }
    ...
    private static Listing Residential(DateTime now, Guid ownerId,
        ...
        string propertyType, string? unitType = null, int? rooms = null, int? bathrooms = null,
        double? area = null, string? floor = null, string? furnished = null,
        string? rentalType = "shared", string? billType = "offer",
        string? gender = null, List<string>? amenities = null)
    {
    ...
    private static Listing Commercial(DateTime now, Guid ownerId,
        string title, string description, decimal price, string time, string district,
        double lat, double lng,
        string propertyType, double? area = null, string? floor = null, int? capacity = null,
        string? parking = null, string? workingHours = null, List<string>? facilities = null)
    {
        var values = new Dictionary<string, object?>
        {
            ["property_type"] = propertyType,
