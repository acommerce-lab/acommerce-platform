        ...
        where T : class, IBaseEntity
{
        ...
        // (F6) Add-without-save: للعمليّات المركَّبة (chat-send: message + conv update).
        // لا SaveChanges هنا — الـ caller يستدعي IUnitOfWork.SaveChangesAsync بعد
        // كلّ adds + edits، فيلتقط الحفظ كلّ التغييرات في معاملة واحدة.
